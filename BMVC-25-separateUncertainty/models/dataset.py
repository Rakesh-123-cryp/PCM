    ...
    def __init__(self, conf):
        ...
        if self.use_init:
            ...
            if self.data_type == 'DTU':
                ...
                self.world_mats_np = [camera_dict['world_mat_{}'.format(i)].astype(np.float32) for i, idx in enumerate(self.images_lis)]
            ...
            if self.data_type == 'DTU':
                ...
                self.scale_mats_np = [camera_dict['scale_mat_{}'.format(i)].astype(np.float32) for i, idx in enumerate(self.images_lis)]
